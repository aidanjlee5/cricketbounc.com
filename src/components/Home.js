  ...
  return (
    <main>
      <div className="home-container">
        <h2 className="welcome">Welcome to BOUNC!</h2>
        {isLoggedIn && userData ? (
          ...
          <div 
            className="team-icon-container panel" 
      ...
      />
        ...
        <div className="panel" id = "heel-life" onClick={handleHeelLifeClick} style={{"background-image":`url(${heellifepagebackground})`}}>
          <img 
            src={heellifeIcon} 
            alt="Heel Life Icon" 
